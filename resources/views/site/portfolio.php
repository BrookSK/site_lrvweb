...
<section class="hero-gradient py-32 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <span class="text-purple-400 text-sm font-semibold uppercase tracking-wider animate-fade-up"><?= \Core\I18n::get('portfolio_badge') ?></span>
        <h1 class="text-4xl md:text-6xl font-bold mt-4 animate-fade-up delay-100"><?= \Core\I18n::get('portfolio_title') ?></h1>
        <p class="text-lg text-gray-300 mt-6 max-w-2xl mx-auto animate-fade-up delay-200"><?= \Core\I18n::get('portfolio_subtitle') ?></p>
    </div>
</section>
...
<section class="section-dark py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap gap-2 mb-12 justify-center" data-animate="fade-up">
            <a href="/<?= $locale ?>/portfolio" class="px-5 py-2.5 rounded-xl text-sm font-medium transition-all <?= !$currentCategory ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/20' : 'bg-white/5 border border-white/10 text-gray-300 hover:border-purple-500/50 hover:text-white' ?>"><?= \Core\I18n::get('portfolio_all') ?></a>
        ...
        <?php if (empty($portfolios)): ?>
            <div class="text-center py-20">
                ...
                <p class="text-gray-400 text-lg"><?= \Core\I18n::get('portfolio_empty') ?></p>
                <a href="/<?= $locale ?>/contato" class="btn-primary mt-6 inline-flex"><?= \Core\I18n::get('request_quote') ?></a>
            </div>
        <?php endif; ?>
    </div>
</section>
