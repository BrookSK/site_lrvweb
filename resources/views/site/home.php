            ...
            <div class="hidden lg:flex justify-center relative">
                <div class="relative w-[420px] h-[420px]">
                    ...
                    <div class="absolute bottom-12 -left-4 glass px-4 py-3 rounded-xl animate-float z-10" style="animation-delay:1.2s">
                        <div class="flex items-center gap-2"><i data-lucide="zap" class="w-4 h-4 text-yellow-400"></i><span class="text-xs text-gray-300">NVMe SSD</span></div>
                    </div>
                    <div class="absolute top-1/4 -left-8 glass px-4 py-3 rounded-xl animate-float z-10" style="animation-delay:0.8s">
                        <div class="flex items-center gap-2"><i data-lucide="shield" class="w-4 h-4 text-blue-400"></i><span class="text-xs text-gray-300">DDoS Protection</span></div>
                    </div>
                    <!-- Centro -->
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-gradient-to-br from-purple-600 to-purple-900 rounded-3xl shadow-2xl shadow-purple-500/30 flex items-center justify-center animate-glow border border-purple-500/30 z-0">
                        <div class="text-center">
                            <i data-lucide="cloud" class="w-12 h-12 text-white mx-auto mb-2"></i>
                    ...
                    <div class="absolute bottom-4 right-4 glass px-4 py-3 rounded-xl animate-float z-10" style="animation-delay:1.8s">
                        <div class="flex items-center gap-2"><i data-lucide="rocket" class="w-4 h-4 text-purple-400"></i><span class="text-xs text-gray-300">Deploy Rápido</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="card-premium border-purple-500/30 lg:row-span-2 flex flex-col justify-between" data-animate="fade-up" data-delay="100">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center"><i data-lucide="cloud" class="w-6 h-6 text-purple-400"></i></div>
            ...
            <div class="card-premium" data-animate="fade-up" data-delay="200">
                <div class="w-10 h-10 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mb-4"><i data-lucide="globe" class="w-5 h-5 text-purple-400"></i></div>
            ...
            <div class="card-premium" data-animate="fade-up" data-delay="300">
                <div class="w-10 h-10 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mb-4"><i data-lucide="settings" class="w-5 h-5 text-purple-400"></i></div>
            ...
            <div class="card-premium" data-animate="fade-up" data-delay="350">
                <div class="w-10 h-10 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mb-4"><i data-lucide="shopping-cart" class="w-5 h-5 text-purple-400"></i></div>
            ...
            <div class="card-premium" data-animate="fade-up" data-delay="400">
                <div class="w-10 h-10 bg-purple-600/20 border border-purple-500/30 rounded-xl flex items-center justify-center mb-4"><i data-lucide="message-circle" class="w-5 h-5 text-purple-400"></i></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-purple-500/30 transition-all duration-300 group" data-animate="fade-up" data-delay="<?= $i * 80 ?>">
                <div class="w-10 h-10 bg-purple-600/10 border border-purple-500/20 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform"><i data-lucide="<?= $f[0] ?>" class="w-5 h-5 text-purple-400"></i></div>
...
<section class="section-dark py-20 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <?php
            $steps = [
                ['message-circle', '01', \Core\I18n::get('step_1_title'), \Core\I18n::get('step_1_desc')],
                ['file-text', '02', \Core\I18n::get('step_2_title'), \Core\I18n::get('step_2_desc')],
                ['rocket', '03', \Core\I18n::get('step_3_title'), \Core\I18n::get('step_3_desc')],
                ['check-circle', '04', \Core\I18n::get('step_4_title'), \Core\I18n::get('step_4_desc')],
            ];
            ...
            <div class="text-center" data-animate="fade-up" data-delay="<?= $i * 120 ?>">
                <div class="w-16 h-16 bg-purple-600/10 border border-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 relative">
                    <i data-lucide="<?= $step[0] ?>" class="w-6 h-6 text-purple-400"></i>
